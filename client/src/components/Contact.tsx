        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-12">
          <Card className="bg-white/5 backdrop-blur-2xl border border-white/10 transition-all duration-300 shadow-xl shadow-black/10 rounded-2xl">
            <CardContent className="p-6 flex items-center gap-4">
              ...
              <div className="flex-1 min-w-0">
                <div className="text-xs uppercase tracking-wider text-foreground mb-1">Email</div>
          ...
          <Card className="bg-white/5 backdrop-blur-2xl border border-white/10 transition-all duration-300 shadow-xl shadow-black/10 rounded-2xl">
            <CardContent className="p-6 flex items-center gap-4">
              ...
              <div className="flex-1 min-w-0">
                <div className="text-xs uppercase tracking-wider text-foreground mb-1">Office</div>
