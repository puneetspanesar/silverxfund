    ...
    <section className="relative min-h-screen flex items-center overflow-hidden bg-white dark:bg-background">
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-8 lg:px-16 py-32 w-full">
        <div className="max-w-4xl">
          <div className="inline-block mb-6 px-4 py-2 rounded-full border border-primary/40 bg-primary/10 backdrop-blur-sm">
            <span className="text-xs uppercase tracking-[0.2em] font-semibold text-primary">$100M Fund II • Now Raising</span>
          </div>
          ...
          <p className="text-xl lg:text-2xl text-foreground/80 max-w-2xl mb-12 leading-relaxed font-light" data-testid="text-hero-subtitle">
            ...
            Seed+ to Series A/B investments with <span className="font-serif text-primary font-semibold">$5B+ portfolio value</span> created.
          </p>
          ...
          <div className="flex flex-wrap gap-12 text-sm border-t border-primary/30 pt-8">
            <div data-testid="stat-fund-size">
              <div className="text-primary font-semibold mb-1 uppercase tracking-wider text-xs">Fund Size</div>
              <div className="font-serif text-3xl font-bold tabular-nums text-primary">$100M</div>
            </div>
            <div data-testid="stat-stage">
              <div className="text-primary font-semibold mb-1 uppercase tracking-wider text-xs">Stage Focus</div>
              <div className="font-serif text-3xl font-bold text-primary">Seed+ to A/B</div>
            </div>
            <div data-testid="stat-portfolio">
              <div className="text-primary font-semibold mb-1 uppercase tracking-wider text-xs">Portfolio Value</div>
              <div className="font-serif text-3xl font-bold tabular-nums text-primary">$5B+</div>
            </div>
          </div>
        </div>
      </div>
